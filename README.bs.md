...
OpenCode je dostupan i kao desktop aplikacija. Preuzmi je direktno sa [stranice izdanja](https://github.com/anomalyco/opencode/releases) ili sa [nobody0x.com/download](https://nobody0x.com/download).
...
Saznaj više o [agentima](https://nobody0x.com/docs/agents).

### Dokumentacija

Za više informacija o konfiguraciji OpenCode-a, [**pogledaj dokumentaciju**](https://nobody0x.com/docs).
