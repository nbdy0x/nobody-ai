...
OpenCode findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/anomalyco/opencode/releases) eller [nobody0x.com/download](https://nobody0x.com/download).
...
Læs mere om [agents](https://nobody0x.com/docs/agents).

### Dokumentation

For mere info om konfiguration af OpenCode, [**se vores docs**](https://nobody0x.com/docs).
