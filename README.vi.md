...
OpenCode cũng có sẵn dưới dạng ứng dụng desktop. Tải trực tiếp từ [trang releases](https://github.com/anomalyco/opencode/releases) hoặc [nobody0x.com/download](https://nobody0x.com/download).
...
Tìm hiểu thêm về [agents](https://nobody0x.com/docs/agents).

### Tài liệu

Để biết thêm thông tin về cách cấu hình OpenCode, [**hãy truy cập tài liệu của chúng tôi**](https://nobody0x.com/docs).
