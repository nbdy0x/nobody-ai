...
OpenCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/opencode/releases) o desde [nobody0x.com/download](https://nobody0x.com/download).
...
Más información sobre [agentes](https://nobody0x.com/docs/agents).

### Documentación

Para más información sobre cómo configurar OpenCode, [**ve a nuestra documentación**](https://nobody0x.com/docs).
