...
OpenCode 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/anomalyco/opencode/releases) 에서 직접 다운로드하거나 [nobody0x.com/download](https://nobody0x.com/download) 를 이용하세요.
...
[agents](https://nobody0x.com/docs/agents) 에 대해 더 알아보세요.

### 문서

OpenCode 설정에 대한 자세한 내용은 [**문서**](https://nobody0x.com/docs) 를 참고하세요.
