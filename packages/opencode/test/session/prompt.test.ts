...
import { NamedError } from "@nobody0x/core/util/error"
...
import { SessionMessageTable } from "@nobody0x/core/session/sql"
...
import { Shell } from "@nobody0x/core/shell"
...
import { LocationServiceMap, locationServiceMapLayer } from "@nobody0x/core/location-services"
...
const writeConfig = Effect.fn("test.writeConfig")(function* (dir: string, config: Partial<ConfigV1.Info>) {
  yield* writeText(
    ...
    JSON.stringify({ $schema: "https://nobody0x.com/config.json", ...config }),
  )
})
