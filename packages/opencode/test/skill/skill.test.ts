...
import { CrossSpawnSpawner } from "@nobody0x/core/cross-spawn-spawner"
...
const withHome = <A, E, R>(home: string, self: Effect.Effect<A, E, R>) =>
  Effect.acquireUseRelease(
    Effect.sync(() => {
      const prev = process.env.NOBODY_TEST_HOME
      process.env.NOBODY_TEST_HOME = home
      return prev
    }),
    () => self,
    (prev) =>
      Effect.sync(() => {
        process.env.NOBODY_TEST_HOME = prev
      }),
  )
...
describe("skill", () => {
  ...
  it.live("discovers skills from .nobody/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".nobody", "skill", "test-skill", "SKILL.md"),
              `---
name: test-skill
      ...
      (dir) =>
        withHome(
          ...
          Effect.gen(function* () {
            yield* Effect.promise(() =>
              Bun.write(
                path.join(dir, ".nobody", "skill", "dir-skill", "SKILL.md"),
                `---
name: dir-skill
...
`,
            ...
            expect(dirs).toContain(path.join(dir, ".nobody", "skill", "dir-skill"))
  ...
  it.live("discovers multiple skills from .nobody/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".nobody", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".nobody", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".nobody", "skill", "no-frontmatter", "SKILL.md"),
              `# No Frontmatter
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".nobody", "skill", "manual-skill", "SKILL.md"),
              `---
name: manual-skill
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".nobody", "skill", "opencode-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .nobody/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".nobody", "skill", "agent-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .nobody/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".nobody", "skills", "agent-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .nobody/skills directory.
---
