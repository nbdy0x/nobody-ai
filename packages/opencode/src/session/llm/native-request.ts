import type { JsonSchema, LLMRequest, ProviderMetadata } from "@nobody0x/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@nobody0x/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @nobody0x/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
