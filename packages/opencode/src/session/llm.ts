...
import { llmClient } from "@nobody0x/core/effect/app-node-platform"
...
import type { LLMEvent } from "@nobody0x/llm"
import { LLMClient } from "@nobody0x/llm/route"
import type { LLMClientService } from "@nobody0x/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @nobody0x/llm. It
