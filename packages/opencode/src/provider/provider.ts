...
import { Hash } from "@nobody0x/core/util/hash"
...
import { optional } from "@nobody0x/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@nobody0x/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
  ...
  return {
    ...
    llmgateway: () =>
      Effect.succeed({
        ...
        options: {
          headers: {
            "HTTP-Referer": "https://nobody0x.com/",
            "X-Title": "opencode",
            "X-Source": "opencode",
          },
        },
