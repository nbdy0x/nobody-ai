...
import { and, Database, eq, isNull, lt, or, sql } from "@nobody0x/console-core/drizzle/index.js"
import { KeyTable } from "@nobody0x/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@nobody0x/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@nobody0x/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@nobody0x/console-core/util/date.js"
import { Identifier } from "@nobody0x/console-core/identifier.js"
import { Billing } from "@nobody0x/console-core/billing.js"
import { Actor } from "@nobody0x/console-core/actor.js"
import { WorkspaceTable } from "@nobody0x/console-core/schema/workspace.sql.js"
import { ZenData } from "@nobody0x/console-core/model.js"
import { Subscription } from "@nobody0x/console-core/subscription.js"
import { BlackData } from "@nobody0x/console-core/black.js"
import { UserTable } from "@nobody0x/console-core/schema/user.sql.js"
import { ModelTable } from "@nobody0x/console-core/schema/model.sql.js"
import { ProviderTable } from "@nobody0x/console-core/schema/provider.sql.js"
...
import { LiteData } from "@nobody0x/console-core/lite.js"
import { Resource } from "@nobody0x/console-resource"
...
import { Workspace } from "@nobody0x/console-core/workspace.js"
...
export async function handler(
      ...
      if (!allowedRegions?.includes("unavailable"))
        throw new RegionError(
          t("zen.api.error.regionNotAllowed", {
            consoleGoUrl: `https://nobody0x.com/workspace/${authInfo.workspaceID}/go`,
          }),
        )
    }
    */
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://nobody0x.com/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://nobody0x.com/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://nobody0x.com/workspace/${authInfo.workspaceID}/members`
