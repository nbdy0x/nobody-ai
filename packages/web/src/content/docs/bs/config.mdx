...
Konfiguracijski fajl ima šemu koja je definirana u [**`nobody0x.com/config.json`**](https://nobody0x.com/config.json).

TUI konfiguracija koristi [**`nobody0x.com/tui.json`**](https://nobody0x.com/tui.json).
