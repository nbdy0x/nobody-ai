...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite opencode i idite na [nobody0x.com/auth](https://nobody0x.com/auth).
...
:::
Evo [primjer razgovora](https://nobody0x.com/s/4XP1fce5) sa OpenCode.
