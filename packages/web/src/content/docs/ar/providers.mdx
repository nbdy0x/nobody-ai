...
1. شغّل الأمر `/connect` في TUI، واختر opencode، ثم انتقل إلى [nobody0x.com/auth](https://nobody0x.com/auth).
...
1. شغّل الأمر `/connect` في TUI، واختر `OpenCode Go`، ثم انتقل إلى [nobody0x.com/auth](https://nobody0x.com/zen).
