...
1. شغّل الأمر `/connect` في واجهة TUI، واختر opencode، ثم انتقل إلى [nobody0x.com/auth](https://nobody0x.com/auth).
...
إليك [مثالا لمحادثة](https://nobody0x.com/s/4XP1fce5) مع OpenCode.
