...
export const TypeId: TypeId = "~@nobody0x/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@nobody0x/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@nobody0x/effect-sqlite-node/NodeSqliteClient")
