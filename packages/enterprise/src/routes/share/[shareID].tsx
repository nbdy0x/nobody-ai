import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@nobody0x/sdk/v2"
import { SessionTurn } from "@nobody0x/session-ui/session-turn"
import { SessionReview } from "@nobody0x/session-ui/session-review"
import { DataProvider } from "@nobody0x/session-ui/context"
import { FileComponentProvider } from "@nobody0x/ui/context/file"
import { WorkerPoolProvider } from "@nobody0x/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@nobody0x/ui/logo"
import { IconButton } from "@nobody0x/ui/icon-button"
import { ProviderIcon } from "@nobody0x/ui/provider-icon"
import { iife } from "@nobody0x/core/util/iife"
...
import { MessageNav } from "@nobody0x/session-ui/message-nav"
import { FileSSR } from "@nobody0x/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@nobody0x/session-ui/pierre/worker").then((m) => ({
