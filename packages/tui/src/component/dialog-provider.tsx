...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@nobody0x/sdk/v2"
        ...
        ({
          opencode: (
            <box gap={1}>
              ...
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://nobody0x.com/zen</span> to get a key
              </text>
            </box>
          ),
          "opencode-go": (
            <box gap={1}>
              ...
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://nobody0x.com/go</span> and enable OpenCode Go
              </text>
            </box>
          ),
