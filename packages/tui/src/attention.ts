...
import defaultSoundPath from "@nobody0x/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@nobody0x/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@nobody0x/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@nobody0x/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@nobody0x/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@nobody0x/ui/audio/yup-01.mp3" with { type: "file" }
