...
import { getFilename } from "@nobody0x/core/util/path"
import { Session } from "@nobody0x/sdk/v2/client"
...
import { toaster } from "@nobody0x/ui/toast"
...
import { retry } from "@nobody0x/core/util/retry"
...
import { useTheme, type ColorScheme } from "@nobody0x/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://nobody0x.com/desktop-feedback")}
      renderPanel={() =>
