...
beforeAll(async () => {
  ...
  mock.module("@nobody0x/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@nobody0x/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@nobody0x/ui/icon", () => ({ Icon: () => null }))
  mock.module("@nobody0x/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
