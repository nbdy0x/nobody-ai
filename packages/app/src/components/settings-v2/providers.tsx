...
import { Tag } from "@nobody0x/ui/v2/badge-v2"
...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "Nobody AI", key: "dialog.provider.opencode.note" },
...
export const SettingsProvidersV2: Component<{ onBack?: () => void }> = (props) => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "Nobody AI" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "Nobody AI" || item.id === "opencode-go"}>
