...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "OpenCode Documentation", href: "https://nobody0x.com/docs" },
      ...
      { type: "separator" },
      {
        ...
        href: "https://github.com/nbdy0x/nobody-ai/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/nbdy0x/nobody-ai/issues/new?template=bug_report.yml",
      },
    ],
  },
]
