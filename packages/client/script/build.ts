...
import { compile, emitEffectImported, emitPromise, write } from "@nobody0x/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@nobody0x/protocol/groups/event"',
            },
          },
        }),
