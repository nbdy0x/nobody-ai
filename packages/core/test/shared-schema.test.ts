...
import { ModelV2 } from "@nobody0x/core/model"
import { SessionV2 } from "@nobody0x/core/session"
import { Agent } from "@nobody0x/schema/agent"
import { Location } from "@nobody0x/schema/location"
import { Model } from "@nobody0x/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@nobody0x/schema/prompt"
import { Provider } from "@nobody0x/schema/provider"
import { Project } from "@nobody0x/schema/project"
import { ProjectDirectories } from "@nobody0x/schema/project-directories"
import { PermissionV1 } from "@nobody0x/schema/permission-v1"
import { Session } from "@nobody0x/schema/session"
import { SessionInput } from "@nobody0x/schema/session-input"
import { SessionMessage } from "@nobody0x/schema/session-message"
import { Workspace } from "@nobody0x/schema/workspace"
import { Command } from "@nobody0x/schema/command"
import { Connection } from "@nobody0x/schema/connection"
import { Credential } from "@nobody0x/schema/credential"
import { FileSystem } from "@nobody0x/schema/filesystem"
import { Integration } from "@nobody0x/schema/integration"
import { LLM } from "@nobody0x/schema/llm"
import { Permission } from "@nobody0x/schema/permission"
import { Plugin } from "@nobody0x/schema/plugin"
import { Pty } from "@nobody0x/schema/pty"
import { Reference } from "@nobody0x/schema/reference"
import { SessionTodo } from "@nobody0x/schema/session-todo"
import { Skill } from "@nobody0x/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@nobody0x/schema/schema"
import { ProviderV2 } from "@nobody0x/core/provider"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@nobody0x/core/command"),
    import("@nobody0x/core/integration/connection"),
    import("@nobody0x/core/credential"),
    import("@nobody0x/core/filesystem"),
    import("@nobody0x/core/integration"),
    import("@nobody0x/core/location"),
    import("@nobody0x/llm"),
    import("@nobody0x/core/permission"),
    import("@nobody0x/core/v1/permission"),
    import("@nobody0x/core/project/copy"),
    import("@nobody0x/core/pty"),
    import("@nobody0x/core/project/schema"),
    import("@nobody0x/core/reference"),
    import("@nobody0x/core/session/input"),
    import("@nobody0x/core/session/message"),
    import("@nobody0x/core/session/todo"),
    import("@nobody0x/core/session/prompt"),
    import("@nobody0x/core/skill"),
    import("@nobody0x/core/v2-schema"),
    import("@nobody0x/core/schema"),
    import("@nobody0x/core/workspace"),
  ])
