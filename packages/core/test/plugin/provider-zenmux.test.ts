...
import { PluginHost } from "@nobody0x/core/plugin/host"
import { ProviderPlugins } from "@nobody0x/core/plugin/provider"
import { ZenmuxPlugin } from "@nobody0x/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://nobody0x.com/", "X-Title": "opencode" })
