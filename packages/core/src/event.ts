...
import type { Data, Definition, Payload } from "@nobody0x/schema/event"
...
import { Durable } from "@nobody0x/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@nobody0x/schema/event").ID
export type { Data, Definition, Payload } from "@nobody0x/schema/event"
