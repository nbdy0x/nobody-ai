...
import type { IntegrationOAuthMethodRegistration } from "@nobody0x/plugin/v2/effect/integration"
import { define } from "@nobody0x/plugin/v2/effect/plugin"
import type { CredentialValue } from "@nobody0x/sdk/v2/types"
...
const defaultServer = "https://console.nobody0x.com"
