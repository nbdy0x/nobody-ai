    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://nobody0x.com/">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://nobody0x.com/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://nobody0x.com/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@nobody0x.com", label: i18n.t("footer.contact") },
    { href: "https://nobody0x.com/discord", label: i18n.t("footer.community") },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://nobody0x.com" aria-label={i18n.t("footer.homeAria")}>
          <OpenCodeMark />
        </a>
