import { OpenCode } from "@nobody0x/client/effect"
...
import { createEmbeddedRoutes } from "@nobody0x/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@nobody0x/sdk-next/OpenCode") {}
